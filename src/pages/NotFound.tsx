...
export const NotFound = () => {
    ...
    return (
        <div className="bg-[#E0E0E0] dark:bg-[#121212] h-screen flex justify-center items-center p-5 relative">
            ...
            <div data-aos="zoom-out" data-aos-duration='600' className="w-11/12 md:w-96 bg-[#EFEFEF] dark:bg-[#1C1C1C] shadow-lg p-5 flex justify-center items-center flex-col gap-4 rounded-md relative z-10">
