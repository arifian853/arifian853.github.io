...
export const Contact = () => {
    return (
        <div className="flex justify-center items-center flex-col md:my-16 my-8">
            ...
            <p className="text-sm opacity-75 md:mb-6 mb-3 md:w-full w-2/3 text-center">Find me at these</p>
            <div className="bg-[#E0E0E0] dark:bg-[#1C1D24] flex flex-row items-center justify-center min-h-[250px] h-auto p-5 gap-5 md:w-4/5 w-full flex-wrap" id="aboutself">
                {
