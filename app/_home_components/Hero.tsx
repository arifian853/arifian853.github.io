...
export function Hero() {
    ...
    return (
        ...
        >
            ...
            />
            <motion.div
                className="absolute top-[60%] right-[20%] w-1.5 h-1.5 rounded-full bg-brand-400/60 dark:bg-brand-400/40 pointer-events-none"
                style={{ y: orb2Y }}
                animate={{
                    scale: [1, 1.8, 1],
                    opacity: [0.4, 0.7, 0.4],
            ...
            />
            <motion.div
                className="absolute top-[35%] left-[5%] w-2 h-2 rounded-full bg-brand-600/40 dark:bg-brand-600/25 pointer-events-none"
                animate={{
                    scale: [1, 1.6, 1],
                    opacity: [0.3, 0.6, 0.3],
                }}
            ...
            >
                ...
                <div className="max-w-3xl">
                    ...
                    >
                        ...
                        <span className="block text-brand-500">Arifian.</span>
                    </motion.h1>
                    ...
                    >
                        I teach <span className="border-b border-brand-500 text-foreground">AI</span> and build{" "}
                        <RotatingText />
                    </motion.p>
                        ...
                        <a href="#about">
                            <Button
                                className="min-h-[48px] px-7 rounded-none border-b-2 border-transparent
                                    hover:border-brand-500 hover:text-brand-500 hover:cursor-pointer
            ...
            >
                <motion.div
                    className="w-px h-12 bg-gradient-to-b from-brand-500/40 to-transparent"
