        ...
        <section id="about" className="relative min-h-screen flex items-center py-20 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 mt-16">
                ...
                >
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-6 flex flex-col justify-center hover:border-sblue-500 dark:hover:border-sblue-500 transition-colors duration-300"
                    >
                        <h3 className="text-sm font-bold font-heading mb-4 text-zinc-600 dark:text-zinc-300 uppercase tracking-wider">
                            Get In Touch
                        </h3>
                        ...
                        <div className="flex justify-center gap-4 pt-2 border-t border-zinc-200 dark:border-zinc-700">
                            {socialLinks.map((social, index) => (
                                ...
                                >
                                    <social.icon
                                        className="w-5 h-5 text-zinc-500 dark:text-zinc-400 group-hover:text-sblue-600 dark:group-hover:text-sblue-400 transition-colors duration-300"
                                    />
                                    {/* Tooltip */}
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                            variants={itemVariants}
                            className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 hover:border-sblue-500 dark:hover:border-sblue-500 transition-colors duration-300"
                        >
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    <div className="flex items-center gap-2 bg-zinc-200 dark:bg-zinc-800 px-3 py-2">
                                        ...
                                        <span className="text-sm font-medium">Groq LLaMA 3.3 70B</span>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium">Slate Blue 500 (Primary Accent)</p>
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400">sblue-500 | #7089A8</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 bg-sblue-700 border border-zinc-300 dark:border-zinc-700" />
                                            <div>
                                                <p className="text-sm font-medium">Slate Blue 700 (Buttons)</p>
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400">sblue-700 | #435A76</p>
                                            </div>
                                        </div>
                                        {/* Background Light */}
                                        <div className="flex items-center gap-3">
                                    ...
                                    <ul className="space-y-3 text-sm">
                                        ...
                                        <li className="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Cards highlight with <code className="bg-zinc-200 dark:bg-zinc-800 px-1">border-sblue-500</code> on hover</p>
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="text-sblue-500 mt-0.5">•</span>
                                        ...
                                        <li className="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Key text uses <code className="bg-zinc-200 dark:bg-zinc-800 px-1">border-b-2 border-sblue-500</code></p>
                                            </div>
                                        </li>
                                    </ul>
                                </motion.div>
