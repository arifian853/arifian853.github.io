...
const socialLinks = [
    {
        name: "@arifiansaputra_",
        icon: SiInstagram,
        url: "https://instagram.com/arifiansaputra_",
    },
    {
        name: "Arifian Saputra",
        icon: SiLinkedin,
        url: "https://linkedin.com/in/arifiansaputra",
    },
...
export function AboutContent() {
    ...
    return (
        ...
        >
            {/* Parallax Orb */}
            <motion.div
                className="absolute left-1/2 top-1/4 -translate-x-1/2 w-[800px] h-[500px] pointer-events-none"
                style={{
                    y: bgY,
                    background:
                ...
                >
                    ...
                    <motion.div variants={cardVariants}>
                        <ShimmerCard className="h-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-6 flex flex-col justify-center hover:border-sblue-500 dark:hover:border-sblue-500 transition-colors duration-300">
                            ...
                            {/* Social Icons */}
                            <div className="flex justify-center gap-4 pt-2 mt-auto border-t border-zinc-200 dark:border-zinc-700">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed mb-8 max-w-3xl">
                            ...
                            projects, and skills. It&apos;s designed with a clean, modern
                            aesthetic and built using some of the latest web technologies.
                            Feel free to explore and get inspired! Anyway, this website is 50%
                            human-crafted and 50% vibe-coded lol.
                        </p>
                                    ...
                                    <ShimmerCard className="h-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 hover:border-sblue-500 dark:hover:border-sblue-500 transition-colors duration-300">
                                        ...
                                        <div className="space-y-4">
                                            <div className="border-b border-zinc-200 dark:border-zinc-800 pb-3">
                                                ...
                                                <code className="text-xs bg-zinc-200 dark:bg-zinc-800 px-2 py-1">
                                                    --font-heading / font-heading
                                                </code>
                                            </div>
                                            <div>
                                                <p className="font-sans text-lg font-medium mb-1">
                                                    Inclusive Sans
                                                </p>
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-2">
                                                    Body Text &amp; UI
                                        ...
                                        <ul className="space-y-3 text-sm">
                                            ...
                                            <li className="flex items-start gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                                        Modular card-based layout with varying spans
                                                    </p>
                                                </div>
                                            </li>
                                            <li className="flex items-start gap-2">
